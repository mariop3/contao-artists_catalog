...
$GLOBALS['TL_DCA']['tl_module']['palettes']['ac_project_list']       = '{title_legend},name,headline,type;{config_legend},ac_showList;{template_legend},imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
...
$GLOBALS['TL_DCA']['tl_module']['fields']['ac_showList'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['ac_showList'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'eval'                    => array('tl_class'=>'w50'),
    'sql'                     => "char(1) NOT NULL default ''"
